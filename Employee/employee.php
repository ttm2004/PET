...
include('../Employee/php/total.php');

session_start();
if ($_SESSION['role'] != 'employee') {
  // Nếu không phải là nhân viên thì quay trở lại trang đăng nhập
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item" href="table-data-oder.php"><i class='app-menu__icon bx bx-task'></i><span
            class="app-menu__label" style="white-space: wrap;">Thông tin chăm sóc thú cưng</span></a></li>
